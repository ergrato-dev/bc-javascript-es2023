...
```markdown
![Anatomía de una Clase](../0-assets/01-clases-basicas.svg)

<img src="../0-assets/02-metodos-estaticos.svg" alt="Métodos Estáticos" width="100%">
```

### Insertar en HTML

```html
<img src="0-assets/03-herencia.svg" alt="Herencia en JavaScript" class="diagram">
